...
#define ENC28J60_CONTROL_MO		PORTB5
#define ENC28J60_CONTROL_MI		PORTB6
...
void enc28j60Init(uint8_t* macaddr)
{
	...
	CSPASSIVE;			// ss=0
	ENC28J60_CONTROL_DDR |= (1<<ENC28J60_CONTROL_MO) | (1<<ENC28J60_CONTROL_SCK) | (1<<PORTB4); // mosi, sck output
	ENC28J60_CONTROL_DDR &=~(1<<ENC28J60_CONTROL_MI); // MISO is input
...
void enc28j60PacketSend(uint16_t len, uint8_t* packet)
{
	...
	//enc28j60WriteOp(ENC28J60_WRITE_BUF_MEM, 0, 0x0E);
